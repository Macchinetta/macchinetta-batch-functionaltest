...
/**
 * JavaConfig class for JobReadTsv job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadTsvConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadTsv.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadTsv(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobReadTsv",
                jobRepository)
                .start(step01)
                .build();
    }
