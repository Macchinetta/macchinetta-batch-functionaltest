...
/**
 * JavaConfig class for JobInputValidationContinue job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobInputValidationContinueConfig {
    ...
    public Step jobScopeStep01(JobRepository jobRepository,
                       ...
                       ItemReader<VerificationSalesPlanDetail> reader,
                       ItemWriter<SalesPlanDetail> writer,
                       ValidateAndContinueItemProcessor processor,
                       LoggingItemReaderListener listener) {
        return new StepBuilder("jobInputValidationContinue.step01",
                jobRepository)
    ...
    @Bean
    public Job jobInputValidationContinue(JobRepository jobRepository,
                                            Step jobScopeStep01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobInputValidationContinue",
                jobRepository)
