...
/**
 * JavaConfig class for JobInputValidationAbort job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobInputValidationAbortConfig {
    ...
    public Step jobScopeStep01(JobRepository jobRepository,
                       ...
                       ValidateAndAbortItemProcessor processor,
                       LoggingItemReaderListener listener) {
        return new StepBuilder("jobInputValidationAbort.step01",
                jobRepository)
    ...
    @Bean
    public Job jobInputValidationAbort(JobRepository jobRepository,
                                            Step jobScopeStep01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobInputValidationAbort",
                jobRepository)
