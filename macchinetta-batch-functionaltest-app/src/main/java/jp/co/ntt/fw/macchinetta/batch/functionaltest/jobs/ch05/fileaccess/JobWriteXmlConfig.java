...
/**
 * JavaConfig class for JobWriteXml job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteXmlConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteXml.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteXml(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobWriteXml",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
