...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch04.listener.ReaderWriterClosingTasklet;
import jp.co.ntt.fw.macchinetta.batch.functionaltest.config.JobBaseContextConfig;

/**
 * JavaConfig class for TaskletJobWithAbortListener job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class TaskletJobWithAbortListenerConfig {
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       ReaderWriterClosingTasklet tasklet,
                       CheckingJobParameterErrorStepExecutionListener listener) {
        return new StepBuilder("taskletJobWithAbortListener.step01",
                jobRepository)
    ...
    @Bean
    public Job taskletJobWithAbortListener(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("taskletJobWithAbortListener",
                jobRepository)
                .start(step01)
                .build();
    }
