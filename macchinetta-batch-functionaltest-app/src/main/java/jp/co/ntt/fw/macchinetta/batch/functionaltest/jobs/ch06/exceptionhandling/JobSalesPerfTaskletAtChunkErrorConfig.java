...
/**
 * JavaConfig class for JobSalesPerfTaskletAtChunkError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfTaskletAtChunkErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       ChunkAroundListener chunkAroundListener) {
        return new StepBuilder("jobSalesPerfTaskletAtChunkError.step01",
                jobRepository)
                .tasklet(salesPerformanceTasklet, transactionManager)
                .listener(chunkAroundListener)
                .build();
    }

    @Bean
    public Job jobSalesPerfTaskletAtChunkError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfTaskletAtChunkError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
