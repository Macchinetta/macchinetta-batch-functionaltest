...
/**
 * JavaConfig class for JobWriteCsvEnclosedFields job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteCsvEnclosedFieldsConfig {
    ...
    public FlatFileItemWriter<SalesPlanDetail> writer(
        ...
        lineAggregator.setAllEnclosing(false);
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteCsvEnclosedFields.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteCsvEnclosedFields(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobWriteCsvEnclosedFields",
                jobRepository)
                .start(step01)
                .build();
    }
