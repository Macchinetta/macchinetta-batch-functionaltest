...
/**
 * JavaConfig class for JobSalesPerfAtChunkError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtChunkErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfAtChunkError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtChunkError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtChunkError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
