...
/**
 * JavaConfig class for JobWriteFixedLengthSeparateFixedLength job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteFixedLengthSeparateFixedLengthConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteFixedLengthSeparateFixedLength.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteFixedLengthSeparateFixedLength(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobWriteFixedLengthSeparateFixedLength",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
