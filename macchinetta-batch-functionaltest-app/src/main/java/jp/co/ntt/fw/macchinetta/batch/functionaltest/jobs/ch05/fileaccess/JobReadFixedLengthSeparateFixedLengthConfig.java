...
/**
 * JavaConfig class for JobReadFixedLengthSeparateFixedLength job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadFixedLengthSeparateFixedLengthConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadFixedLengthSeparateFixedLength.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadFixedLengthSeparateFixedLength(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobReadFixedLengthSeparateFixedLength",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
