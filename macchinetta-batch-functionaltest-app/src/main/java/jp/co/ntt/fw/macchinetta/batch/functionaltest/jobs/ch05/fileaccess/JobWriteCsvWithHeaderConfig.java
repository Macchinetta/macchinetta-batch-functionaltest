...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch05.fileaccess.module.WriteHeaderFlatFileFooterCallback;
import jp.co.ntt.fw.macchinetta.batch.functionaltest.config.JobBaseContextConfig;

/**
 * JavaConfig class for JobWriteCsvWithHeader job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteCsvWithHeaderConfig {
    ...
    public FlatFileItemWriter<Customer> writer(
        ...
        return new FlatFileItemWriterBuilder<Customer>()
                ...
                .headerCallback(writeHeaderFlatFileFooterCallback)
                .build();
    }
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteCsvWithHeader.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteCsvWithHeader(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobWriteCsvWithHeader",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
