...
/**
 * JavaConfig class for JobSalesPerfAtSkipSpecificProcError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtSkipSpecificProcErrorConfig {
    ...
    @Bean
    public AmountCheckWithSkipProcessor amountCheckProcessor() {
        AmountCheckWithSkipProcessor processor = new AmountCheckWithSkipProcessor();
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfAtSkipSpecificProcError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtSkipSpecificProcError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtSkipSpecificProcError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
