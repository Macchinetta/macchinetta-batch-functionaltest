...
/**
 * JavaConfig class for JobInputValidationMessage job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobInputValidationMessageConfig {
    ...
    public Step jobScopeStep01(JobRepository jobRepository,
                       ...
                       ValidateAndMessageItemProcessor processor,
                       LoggingItemReaderListener listener) {
        return new StepBuilder("jobInputValidationMessage.step01",
                jobRepository)
    ...
    @Bean
    public Job jobInputValidationMessage(JobRepository jobRepository,
                                            Step jobScopeStep01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobInputValidationMessage",
                jobRepository)
