...
/**
 * JavaConfig class for DBAccessByItemProcessor job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class DBAccessByItemProcessorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("DBAccessByItemProcessor.step01",
                jobRepository)
    ...
    @Bean
    public Job DBAccessByItemProcessor(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("DBAccessByItemProcessor",
                jobRepository)
                .start(step01)
                .listener(listener)
                .build();
