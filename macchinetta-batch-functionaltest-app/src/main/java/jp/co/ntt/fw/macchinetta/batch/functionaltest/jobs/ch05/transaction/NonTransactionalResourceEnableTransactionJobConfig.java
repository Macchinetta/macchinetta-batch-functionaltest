...
/**
 * JavaConfig class for NonTransactionalResourceEnableTransactionJob.
 *
 * @since 2.5.0
 */
@Configuration
...
public class NonTransactionalResourceEnableTransactionJobConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("nonTransactionalResourceEnableTransactionJob.step01",
                jobRepository)
    ...
    @Bean
    public Job nonTransactionalResourceEnableTransactionJob(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("nonTransactionalResourceEnableTransactionJob", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
