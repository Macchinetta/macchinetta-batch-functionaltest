...
/**
 * JavaConfig class for UpdateMapperAndItemWriterJob job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class UpdateMapperAndItemWriterJobConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("updateMapperAndItemWriterJob.step01",
                jobRepository)
    ...
    @Bean
    public Job updateMapperAndItemWriterJob(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("updateMapperAndItemWriterJob",
                jobRepository)
                .start(step01)
                .listener(listener)
                .build();
