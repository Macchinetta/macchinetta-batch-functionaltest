...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch05.exclusivecontrol.OptimisticLockTasklet;
import jp.co.ntt.fw.macchinetta.batch.functionaltest.config.JobBaseContextConfig;

/**
 * JavaConfig class for TaskletOptimisticLockCheckJob.
 *
 * @since 2.5.0
 */
@Configuration
...
public class TaskletOptimisticLockCheckJobConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("taskletOptimisticLockCheckJob.step01",
                jobRepository)
                .tasklet(optimisticLockTasklet, transactionManager)
                .build();
    }
