...
/**
 * JavaConfig class for JobSalesPlan02 job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPlan02Config {

    @Bean
    public MyBatisCursorItemReader<SalesPlanSummary> summarizeInvoice(
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       MyBatisCursorItemReader<SalesPlanSummary> summarizeDetails,
                       MyBatisBatchItemWriter<SalesPlanSummary> summaryWriter) {
        return new StepBuilder("jobSalesPlan02.step01", jobRepository)
                .<SalesPlanSummary, SalesPlanSummary> chunk(10, transactionManager)
    ...
    @Bean
    public Job jobSalesPlan02(JobRepository jobRepository, Step step01,
                                 @Qualifier("jobExecutionLoggingListener") JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPlan02", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
