...
/**
 * JavaConfig class for OutputSalesPlanDetailWithNoTran job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class OutputSalesPlanDetailWithNoTranConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("outputSalesPlanDetailWithNoTran.step01",
                jobRepository)
    ...
    @Bean
    public Job outputSalesPlanDetailWithNoTran(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("outputSalesPlanDetailWithNoTran",jobRepository)
                .start(step01)
                .build();
    }
}
