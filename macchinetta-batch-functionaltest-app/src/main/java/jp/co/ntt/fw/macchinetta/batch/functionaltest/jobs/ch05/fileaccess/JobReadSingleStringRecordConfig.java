...
/**
 * JavaConfig class for JobReadSingleStringRecord job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadSingleStringRecordConfig {

    @Bean
    @StepScope
    public FlatFileItemReader<String> reader(
            @Value("#{jobParameters['inputFile']}") File inputFile) {
        final PassThroughLineMapper lineMapper = new PassThroughLineMapper();
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadSingleStringRecord.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadSingleStringRecord(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobReadSingleStringRecord",
                jobRepository)
                .start(step01)
                .build();
    }
