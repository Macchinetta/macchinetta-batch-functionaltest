...
/**
 * JavaConfig class for JobSalesPerfAtComponentsError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtComponentsErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       ItemProcessListener<SalesPerformanceDetail, SalesPerformanceDetail> listener) {
        return new StepBuilder("jobSalesPerfAtComponentsError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtComponentsError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtComponentsError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
