...
/**
 * JavaConfig class for JobCustomerList01 job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobCustomerList01Config {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobCustomerList01.step01", jobRepository)
    ...
    @Bean
    public Job jobCustomerList01(JobRepository jobRepository, Step step01,
                                 @Qualifier("jobExecutionLoggingListener") JobExecutionLoggingListener listener) {
        return new JobBuilder("jobCustomerList01", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
