...
/**
 * JavaConfig class for JobReadCsvEnclosedFields job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadCsvEnclosedFieldsConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadCsvEnclosedFields.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadCsvEnclosedFields(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobReadCsvEnclosedFields",
                jobRepository)
                .start(step01)
                .build();
    }
