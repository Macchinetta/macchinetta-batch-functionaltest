...
/**
 * JavaConfig class for JobSalesPerfAtInvalidSkipReadError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtInvalidSkipReadErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfAtInvalidSkipReadError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtInvalidSkipReadError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtInvalidSkipReadError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
