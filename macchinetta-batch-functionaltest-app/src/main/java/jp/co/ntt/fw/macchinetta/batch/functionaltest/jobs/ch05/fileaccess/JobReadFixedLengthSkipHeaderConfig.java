...
/**
 * JavaConfig class for JobReadFixedLengthSkipHeader job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadFixedLengthSkipHeaderConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadFixedLengthSkipHeader.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadFixedLengthSkipHeader(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobReadFixedLengthSkipHeader",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
