...
public class LaunchContextConfig {
    ...
    @Bean(destroyMethod = "close", name = "adminDataSource")
    @Profile("embedded")
    public BasicDataSource adminDataSourceEmbedded(@Value("${admin.h2.jdbc.driver}") String driverClassName,
    ...
    @Bean(name = "dataSourceInitializer")
    @Profile("embedded")
    public DataSourceInitializer dataSourceInitializerEmbedded(@Qualifier("adminDataSource") DataSource adminDataSource,
