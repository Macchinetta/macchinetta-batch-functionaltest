...
/**
 * JavaConfig class for JobInputValidationBulkMessage job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobInputValidationBulkMessageConfig {
    ...
    public Step jobScopeStep01(JobRepository jobRepository,
                       ...
                       ValidateAndBulkMessageItemProcessor processor,
                       LoggingItemReaderListener listener) {
        return new StepBuilder("jobInputValidationBulkMessage.step01",
                jobRepository)
    ...
    @Bean
    public Job jobInputValidationBulkMessage(JobRepository jobRepository,
                                            Step jobScopeStep01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobInputValidationBulkMessage",
                jobRepository)
