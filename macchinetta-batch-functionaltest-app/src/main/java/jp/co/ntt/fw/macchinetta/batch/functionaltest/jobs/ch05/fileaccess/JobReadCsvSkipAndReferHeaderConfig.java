...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch05.fileaccess.module.HoldHeaderLineCallbackHandler;
...
/**
 * JavaConfig class for JobReadCsvSkipAndReferHeader job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadCsvSkipAndReferHeaderConfig {
    ...
    public FlatFileItemReader<SalesPlanDetail> reader(
            ...
            @Qualifier("lineCallbackHandler") HoldHeaderLineCallbackHandler lineCallbackHandler) {
