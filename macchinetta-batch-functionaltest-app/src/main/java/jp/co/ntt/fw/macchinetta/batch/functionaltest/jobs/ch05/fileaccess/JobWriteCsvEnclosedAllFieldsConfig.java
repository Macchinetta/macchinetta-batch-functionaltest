...
/**
 * JavaConfig class for JobWriteCsvEnclosedAllFields job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteCsvEnclosedAllFieldsConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteCsvEnclosedAllFields.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteCsvEnclosedAllFields(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobWriteCsvEnclosedAllFields",
                jobRepository)
                .start(step01)
                .build();
    }
