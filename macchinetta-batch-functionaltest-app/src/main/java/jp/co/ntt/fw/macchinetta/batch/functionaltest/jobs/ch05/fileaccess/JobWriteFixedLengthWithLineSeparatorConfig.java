...
/**
 * JavaConfig class for JobWriteFixedLengthWithLineSeparator job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteFixedLengthWithLineSeparatorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteFixedLengthWithLineSeparator.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteFixedLengthWithLineSeparator(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobWriteFixedLengthWithLineSeparator",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
