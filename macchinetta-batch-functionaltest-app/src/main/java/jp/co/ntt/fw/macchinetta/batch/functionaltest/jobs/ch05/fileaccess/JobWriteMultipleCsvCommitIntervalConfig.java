...
/**
 * JavaConfig class for JobWriteMultipleCsvCommitInterval job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobWriteMultipleCsvCommitIntervalConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobWriteMultipleCsvCommitInterval.step01",
                jobRepository)
    ...
    @Bean
    public Job jobWriteMultipleCsvCommitInterval(JobRepository jobRepository,
                                            Step step01,
                                            JobExecutionLoggingListener listener) {
        return new JobBuilder("jobWriteMultipleCsvCommitInterval",jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
