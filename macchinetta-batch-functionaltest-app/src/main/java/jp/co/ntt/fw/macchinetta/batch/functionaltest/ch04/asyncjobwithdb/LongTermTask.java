 ...
 * Long term task.
 * <p>
 * Tasklet to imitate long working hours.
 * </p>
 *
 * @since 5.0.0
 */
public class LongTermTask implements Tasklet {
    ...
    /**
     * Execute the task to wait for the specified time.
     *
     ...
     * Waiting time (millisecond).
     *
     * @param waitTime New waitTime (millisecond).
     */
