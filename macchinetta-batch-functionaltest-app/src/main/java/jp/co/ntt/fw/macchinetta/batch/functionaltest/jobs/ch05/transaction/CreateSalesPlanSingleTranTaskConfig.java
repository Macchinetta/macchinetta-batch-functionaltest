...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch05.transaction.component.SalesPlanSingleTranTask;
import jp.co.ntt.fw.macchinetta.batch.functionaltest.config.JobBaseContextConfig;

/**
 * JavaConfig class for CreateSalesPlanSingleTranTask job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class CreateSalesPlanSingleTranTaskConfig {
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       SalesPlanSingleTranTask salesPlanSingleTranTask) {
        return new StepBuilder("createSalesPlanSingleTranTask.step01",
                jobRepository)
                .tasklet(salesPlanSingleTranTask, transactionManager)
                .build();
    }
    
    @Bean
    public Job createSalesPlanSingleTranTask(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("createSalesPlanSingleTranTask",jobRepository)
                .start(step01)
                .build();
    }
}
