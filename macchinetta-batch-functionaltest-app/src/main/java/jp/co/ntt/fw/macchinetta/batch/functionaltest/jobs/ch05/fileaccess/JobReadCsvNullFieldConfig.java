...
/**
 * JavaConfig class for JobReadCsvNullField job.
 *
 * @since 2.5.0
 */
@Configuration
...
@ComponentScan({ "jp.co.ntt.fw.macchinetta.batch.functionaltest.app.common",
        "jp.co.ntt.fw.macchinetta.batch.functionaltest.ch05.fileaccess" })
public class JobReadCsvNullFieldConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadCsvNullField.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadCsvNullField(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobReadCsvNullField",
                jobRepository)
                .start(step01)
                .build();
    }
