...
/**
 * JavaConfig class for JobSalesPerfAtStepError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtStepErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       StepErrorLoggingListener listener) {
        return new StepBuilder("jobSalesPerfAtStepError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtStepError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtStepError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
