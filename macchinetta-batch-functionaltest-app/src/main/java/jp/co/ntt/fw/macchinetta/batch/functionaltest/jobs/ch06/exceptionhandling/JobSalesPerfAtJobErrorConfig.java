...
/**
 * JavaConfig class for JobSalesPerfAtJobError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtJobErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfAtJobError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtJobError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener JobExecutionLoggingListener,
                                              JobErrorLoggingListener jobErrorLoggingListener) {
        return new JobBuilder("jobSalesPerfAtJobError", jobRepository)
                .start(step01)
                .listener(JobExecutionLoggingListener)
                .listener(jobErrorLoggingListener)
                .build();
    }
}
