...
/**
 * JavaConfig class for JobSalesPerfTaskletAtStepError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfTaskletAtStepErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfTaskletAtStepError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfTaskletAtStepError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfTaskletAtStepError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
