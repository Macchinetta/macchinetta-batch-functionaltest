...
public class ExclusiveBranch {
     ...
     * Old branch name.
     *
     * @return The current old branch name.
     */
     ...
     * Old branch name.
     *
     * @param oldBranchName New old branch name.
     */
    ...
    public String toString() {
        return "ExclusiveBranch{" + "branchId='" + branchId + '\'' + ", branchName='" + branchName + '\''
                + ", branchAddress='" + branchAddress + '\'' + ", branchTel='" + branchTel + '\'' + ", createDate="
                + createDate + ", updateDate=" + updateDate + ", oldBranchName='" + oldBranchName + '\'' + '}';
    }
}
