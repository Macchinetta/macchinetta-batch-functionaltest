...
/**
 * Model of Sales Performance Detail.
 *
 * @since 5.0.0
 */
public class SalesPerformanceDetail implements Serializable {

    private static final long serialVersionUID = 2409271430184989465L;
    ...
    public String toString() {
        return "SalesPerformanceDetail{" + "branchId='" + branchId + '\'' + ", year=" + year + ", month=" + month
