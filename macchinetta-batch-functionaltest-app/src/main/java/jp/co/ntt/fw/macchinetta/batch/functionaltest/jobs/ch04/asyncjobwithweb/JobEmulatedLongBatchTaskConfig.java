...
public class JobEmulatedLongBatchTaskConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobEmulatedLongBatchTask.step01",
                jobRepository)
    ...
    @Bean
    public Job jobEmulatedLongBatchTask(JobRepository jobRepository,
                                                 Step step01) {
        return new JobBuilder("jobEmulatedLongBatchTask",
                jobRepository)
                .start(step01)
                .build();
    }
