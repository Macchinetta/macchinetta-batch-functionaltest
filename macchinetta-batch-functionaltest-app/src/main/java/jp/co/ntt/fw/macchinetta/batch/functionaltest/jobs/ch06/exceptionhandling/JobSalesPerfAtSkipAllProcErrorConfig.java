...
/**
 * JavaConfig class for JobSalesPerfAtSkipAllProcError job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobSalesPerfAtSkipAllProcErrorConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobSalesPerfAtSkipAllProcError.step01",
                jobRepository)
    ...
    @Bean
    public Job jobSalesPerfAtSkipAllProcError(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("jobSalesPerfAtSkipAllProcError", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
