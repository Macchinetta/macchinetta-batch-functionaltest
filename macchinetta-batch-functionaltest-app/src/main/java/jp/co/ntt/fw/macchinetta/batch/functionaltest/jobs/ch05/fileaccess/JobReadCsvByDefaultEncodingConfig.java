...
/**
 * JavaConfig class for JobReadCsvByDefaultEncoding job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class JobReadCsvByDefaultEncodingConfig {
    ...
    public Step step01(JobRepository jobRepository,
        ...
        return new StepBuilder("jobReadCsvByDefaultEncoding.step01",
                jobRepository)
    ...
    @Bean
    public Job jobReadCsvByDefaultEncoding(JobRepository jobRepository,
                                            Step step01) {
        return new JobBuilder("jobReadCsvByDefaultEncoding",
                jobRepository)
                .start(step01)
                .build();
    }
