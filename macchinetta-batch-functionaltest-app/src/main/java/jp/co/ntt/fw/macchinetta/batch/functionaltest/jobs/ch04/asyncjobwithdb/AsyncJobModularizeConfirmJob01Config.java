...
import jp.co.ntt.fw.macchinetta.batch.functionaltest.ch04.asyncjobwithdb.module.ModularizationConfirmationItemProcessor01;
import jp.co.ntt.fw.macchinetta.batch.functionaltest.config.JobBaseContextConfig;

/**
 * JavaConfig class for AsyncJobModularizeConfirmJob01 job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class AsyncJobModularizeConfirmJob01Config {
    ...
    @Bean
    public ModularizationConfirmationItemProcessor01 jobDBPolling06Processor() {
        return new ModularizationConfirmationItemProcessor01();
    }
    ...
    public Step step01(JobRepository jobRepository,
                       ...
                       ModularizationConfirmationItemProcessor01 processor,
                       @Qualifier("jobDBPolling06Writer") LoggingItemWriter writer) {
        return new StepBuilder("asyncJobModularizeConfirmJob01.step01",
                jobRepository)
    ...
    @Bean
    public Job asyncJobModularizeConfirmJob01(JobRepository jobRepository,
                                              Step step01,
                                              JobExecutionLoggingListener listener) {
        return new JobBuilder("asyncJobModularizeConfirmJob01", jobRepository)
                .start(step01)
                .listener(listener)
                .build();
    }
