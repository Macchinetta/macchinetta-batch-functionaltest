...
/**
 * JavaConfig class for TaskletJobWithListenerAnnotation job.
 *
 * @since 2.5.0
 */
@Configuration
...
public class TaskletJobWithListenerAnnotationConfig {
    ...
    public Step jobScopeStep01(JobRepository jobRepository,
        ...
        return new StepBuilder("taskletJobWithListenerAnnotationWithinJobScope.step01",
                jobRepository)
    ...
    @Bean
    public Job taskletJobWithListenerAnnotationWithinJobScope(JobRepository jobRepository,
                                            @Qualifier("jobScopeStep01") Step jobScopeStep01,
                                            AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new JobBuilder("taskletJobWithListenerAnnotationWithinJobScope",
                jobRepository)
    ...
    public Step stepScopeStep01(JobRepository jobRepository,
                       @Qualifier("jobTransactionManager") PlatformTransactionManager transactionManager,
                       AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new StepBuilder("taskletJobWithListenerAnnotationWithinStepScope.step01",
                jobRepository)
                .listener(tasklet)
                .tasklet(tasklet, transactionManager)
                .build();
    ...
    @Bean
    public Job taskletJobWithListenerAnnotationWithinStepScope(JobRepository jobRepository,
                                            @Qualifier("stepScopeStep01") Step stepScopeStep01) {
        return new JobBuilder("taskletJobWithListenerAnnotationWithinStepScope",
                jobRepository)
    ...
    public Step taskletScopeStep01(JobRepository jobRepository,
                       @Qualifier("jobTransactionManager") PlatformTransactionManager transactionManager,
                       AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new StepBuilder("taskletJobWithListenerAnnotationWithinTaskletScope.step01",
                jobRepository)
                .tasklet(tasklet, transactionManager)
                .listener(tasklet)
                .build();
    ...
    @Bean
    public Job taskletJobWithListenerAnnotationWithinTaskletScope(JobRepository jobRepository,
                                            @Qualifier("taskletScopeStep01") Step taskletScopeStep01) {
        return new JobBuilder("taskletJobWithListenerAnnotationWithinTaskletScope",
                jobRepository)
    ...
    public Step allScopeStep01(JobRepository jobRepository,
                       @Qualifier("jobTransactionManager") PlatformTransactionManager transactionManager,
                       AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new StepBuilder("taskletJobWithListenerAnnotationWithinAllScope.step01",
                jobRepository)
                .listener(tasklet)
                .tasklet(tasklet, transactionManager)
                .listener(tasklet)
    ...
    @Bean
    public Job taskletJobWithListenerAnnotationWithinAllScope(JobRepository jobRepository,
                                            @Qualifier("allScopeStep01") Step allScopeStep01,
                                            AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new JobBuilder("taskletJobWithListenerAnnotationWithinAllScope",
                jobRepository)
    ...
    public Step implicitScopeStep01(JobRepository jobRepository,
                       @Qualifier("jobTransactionManager") PlatformTransactionManager transactionManager,
                       AnnotationSalesPlanDetailRegisterTasklet tasklet) {
        return new StepBuilder("taskletJobWithListenerAnnotationWithinImplicitScope.step01",
                jobRepository)
                .tasklet(tasklet, transactionManager)
                .build();
    }
    ...
    @Bean
    public Job taskletJobWithListenerAnnotationWithinImplicitScope(JobRepository jobRepository,
                                            @Qualifier("implicitScopeStep01") Step implicitScopeStep01) {
        return new JobBuilder("taskletJobWithListenerAnnotationWithinImplicitScope",
                jobRepository)
